...
export class WebsiteListComponent implements OnInit {
  ...
  onWebsiteSelect(website: Website, thisEl) {
    let parentEl = thisEl.currentTarget.parentElement;
    let allItems = document.querySelectorAll(".item-1");
  ...
  onPageSelect(page: Page, thisEl) {
    let parentEl = thisEl.currentTarget.parentElement;
    let allItems = document.querySelectorAll(".item-2");
    this.highlightActiveElement(parentEl, allItems);
  ...
  toggleSection(sectionNumber) {
    let tabEpic = document.getElementById("tab-1");
    let tabStory = document.getElementById("tab-2");
