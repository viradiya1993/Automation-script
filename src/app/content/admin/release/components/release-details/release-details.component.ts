...
export class ReleaseDetailsComponent implements OnInit {
  ...
  onReleaseSaveClick() {
    console.log(this.releaseDetailsForm.getRawValue());
    ...
    if (this.release.releaseId) {
      this.releaseService.updateRelease(this.release).subscribe(() => {
        this.notificationService.showNotification('Release updated successfully', '', 'top', 'right');
      });
    } else {
      this.releaseService.addRelease(this.release).subscribe(() => {
        this.notificationService.showNotification('Release created successfully', '', 'top', 'right');
      });
    }
  }
